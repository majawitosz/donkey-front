...
export default function CompanyLocationForm({ initialConfig }: CompanyLocationFormProps) {
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Define the central point and radius for employee attendance check-ins.
                </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <div className="space-y-4">
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormDescription>
                                                The allowed distance from the center point.
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                {success && (
                                    <p className="text-sm text-green-600 mt-2">Configuration saved successfully!</p>
                                )}
                            </form>
                        </Form>
                    </div>
